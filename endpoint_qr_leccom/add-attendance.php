        ...
        try {
            ...
            if ($selectStmt->rowCount() > 0) {
                ...
                if ($orgName == 'LecCom') {
                    ...
                    $insertStmt = $pdo->prepare("INSERT INTO tbl_att_leccom (tbl_member_id, name, org_name, time_in) VALUES (:memberID, :memberName, :orgName, :timeIn)");
                    ...
                    if ($insertStmt->execute()) {
                        // Redirect on success
                        header("Location: http://localhost/chapelupdate104/Admin/att_leccom.php");
                        exit();
                    } else {
