...
if (isset($_GET['attendance'])) {
    ...
    try {
        $query = "DELETE FROM tbl_att_comi WHERE tbl_attendance_id = :attendance";
        ...
        if ($stmt->execute()) {
            echo "
                <script>
                    ...
                    window.location.href = 'http://localhost/chapelupdate104/Admin/qr_index_comi.php';
                </script>
            ";
        } else {
            echo "
                <script>
                    ...
                    window.location.href = 'http://localhost/chapelupdate104/Admin/att_comi.php';
                </script>
            ";
        }
