...
if (isset($_GET['attendance'])) {
    ...
    try {
        $query = "DELETE FROM tbl_att_usherette WHERE tbl_attendance_id = :attendance";
        ...
        if ($stmt->execute()) {
            echo "
                <script>
                    ...
                    window.location.href = 'http://localhost/chapelupdate104/Admin/qr_index_usherette.php';
                </script>
            ";
        } else {
            echo "
