    ...
    if (isset($_POST['qr_code'])) {
        ...
        try {
            ...
            if ($selectStmt->rowCount() > 0) {
                ...
                if ($orgName == 'Knights') {
                    ...
                    $insertStmt = $pdo->prepare("INSERT INTO tbl_att_knights (tbl_member_id, name, org_name, time_in) VALUES (:memberID, :memberName, :orgName, :timeIn)");
                    ...
                    if ($insertStmt->execute()) {
                        // Redirect on success
                        header("Location: http://localhost/chapelupdate104/Admin/att_knights.php");
                        exit();
                    } else {
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/chapelupdate104/Organizations/Knights/qr_code_knights.php';
            </script>
        ";
    }
}
