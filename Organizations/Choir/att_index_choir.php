...
<head>
    ...
    <title>Choir's Attendance</title>
...
<body>
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand ml-3" href="#">Choir's Attendance</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item3">
                    <a class="nav-link" href="./att_index_choir.php"> Choir <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="dashboard_choir.php"><i class='bx bxs-dashboard icon'></i>&nbsp;Dashboard</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="main">
        ...
        <div class="attendance-container row">
            <div class="attendance-list"> 
                <h2 align="center">List of Presents in Choir</h2>
