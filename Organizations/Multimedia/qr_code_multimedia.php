...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="dashboard_multimedia.php"><i class='bx bxs-dashboard icon'></i> Dashboard</a></li>
            <li class="divider" data-text="main">Main</li>
            <li><a href="qr_code_multimedia.php" class="active"><i class="bx bx-qr icon"></i>QR Code Attendance</a></li>
            <li>
