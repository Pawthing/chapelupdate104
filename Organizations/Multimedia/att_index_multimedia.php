...
<head>
    ...
    <title>Multimedia's Attendance</title>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                <li>
                    <a class="nav-link ml-3" href="#">Multimedia's Attendance</a>
                </li>
                <li class="nav-item6">
                    <a class="nav-link" href="./att_index_multimed.php"> Multimedia <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="dashboard_multimedia.php"><i class='bx bxs-dashboard icon'></i>&nbsp;Dashboard</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="main">
        ...
        <div class="attendance-container row">
            <div class="attendance-list"> 
                <h2 align="center">List of Presents in Multimedia</h2>
