...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="dashboard_comi.php" class="active"><i class='bx bxs-dashboard icon'></i> Dashboard</a></li>
            <li class="divider" data-text="main">Main</li>
            <li><a href="qr_code_comi.php"><i class="bx bx-qr icon"></i>QR Code for Attendance</a></li>
            <li>
                <a href="att_index_comi.php"><i class='bx bx-qr-scan icon'></i> Attendance </a>
            </li> 
    ...
    <section id="content">
        <!-- NAVBAR -->
         <nav>
            ...
            <a href="profile_comi.php" class="nav-link">
            <h4><b>
            <?php
                try {
                    $user_id = $_SESSION['user_id']; 
            ...
            <div class="profile">
                ...
                <ul class="profile-link">
                    <li><a href="profile_comi.php"><i class='bx bxs-user-circle icon'></i> Profile </a></li>
