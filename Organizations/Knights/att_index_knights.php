...
<head>
    ...
    <title>Knights Attendance</title>
...
<body>
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand ml-3" href="#">Knights Attendance</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item1">
                    <a class="nav-link" href="./att_index_knights.php"> Knights <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="dashboard_knights.php"><i class='bx bxs-dashboard icon'></i>&nbsp;Dashboard</a>
                </li>
            </ul>
        </div>
    </nav>
