...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="dashboard_knights.php" class="active"><i class='bx bxs-dashboard icon'></i> Dashboard</a></li>
    ...
    <section id="content">
        <!-- NAVBAR -->
         <nav>
            ...
            <a href="profile_knights.php" class="nav-link">
            <h4><b>
            <?php
                try {
                    $user_id = $_SESSION['user_id']; 
            ...
            <div class="profile">
                ...
                <ul class="profile-link">
                    <li><a href="profile_knights.php"><i class='bx bxs-user-circle icon'></i> Profile </a></li>
