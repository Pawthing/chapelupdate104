...
if(isset($_REQUEST['save-event']))
{
    ...
    $insert_query = mysqli_query($connection, "insert into tbl_calendar set title='$title', start_date='$start_date', end_date='$end_date'");
    if($insert_query)
    {
...
$fetch_event = mysqli_query($connection, "select * from tbl_calendar");
?>
<script>
