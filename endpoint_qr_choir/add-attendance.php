    ...
    if (isset($_POST['qr_code'])) {
        ...
        try {
            ...
            if ($selectStmt->rowCount() > 0) {
                ...
                if ($orgName == 'Choir') {
                    ...
                    $insertStmt = $pdo->prepare("INSERT INTO tbl_att_choir (tbl_member_id, name, org_name, time_in) VALUES (:memberID, :memberName, :orgName, :timeIn)");
                    ...
                    if ($insertStmt->execute()) {
                        // Redirect on success
                        header("Location: http://localhost/chapelupdate104/Admin/att_choir.php");
                        exit();
                    } else {
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/chapelupdate104/Organizations/Choir/qr_code_choir.php';
            </script>
        ";
    }
}
