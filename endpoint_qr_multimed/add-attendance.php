    ...
    if (isset($_POST['qr_code'])) {
        ...
        try {
            ...
            if ($selectStmt->rowCount() > 0) {
                ...
                if ($orgName == 'Multimedia') {
                    // Prepare and execute the insertion statement
                    $insertStmt = $pdo->prepare("INSERT INTO tbl_att_multi (tbl_member_id, name, org_name, time_in) VALUES (:memberID, :memberName, :orgName, :timeIn)");
                    ...
                    if ($insertStmt->execute()) {
                        // Redirect on success
                        header("Location: http://localhost/chapelupdate104/Admin/att_multimedia.php");
                        exit();
                    } else {
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/chapelupdate104/Organizations/Multimedia/qr_code_multimedia.php';
            </script>
        ";
    }
}
