...
<head>
    ...
    <title>Attendance - Usherette</title>
        ...
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown show">
                    ...
                    <li><a href="att_usherette.php"><i class='bx bxs-user-check icon'></i><b>Usherettes</b></a></li>
                </ul>
            </li> 
        ...
        <div class="attendance-container row">
            <div class="qr-container col-4">
                ...
                <div class="qr-detected-container" style="display: none;">
                    <form action="../endpoint_qr_usherette/add-attendance.php" method="POST">
            ...
            <div class="attendance-list">
                <h4 align ="center">List of Present in Usherettes</h4>
    ...
    <script>
        ...
        function deleteAttendance(id) {
            if (confirm("Do you want to remove this attendance?")) {
                window.location = "../endpoint_qr_usherette/delete-attendance.php?attendance=" + id;
            }
        }
    </script>
        </main>
