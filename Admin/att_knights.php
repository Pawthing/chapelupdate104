...
<head>
    ...
    <title>Attendance - Knights</title>
        ...
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown show">
                    ...
                    <li><a href="att_knights.php"><i class='bx bxs-user-check icon'></i><b>Knights</b></a></li>
        ...
        <div class="attendance-container row">
            <div class="qr-container col-4">
                <div class="scanner-con">
                    <h5 class="text-center">Scan your QR Code here for the attendance</h5>
                    <video id="interactive" class="viewport" width="100%">
                </div>

                <div class="qr-detected-container" style="display: none;">
                    <form action="../endpoint_qr_knights/add-attendance.php" method="POST">
            ...
            <div class="attendance-list">
                <h4 align="center">List of Present in Knights</h4>
