        ...
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown show">
                    ...
                    <li><a href="att_leccom.php"><i class='bx bxs-user-check icon'></i><b>LecCom</b></a></li>
        ...
        <div class="attendance-container row">
            <div class="qr-container col-4">
                ...
                <div class="qr-detected-container" style="display: none;">
                    <form action="../endpoint_qr_leccom/add-attendance.php" method="POST">
                        <h4 class="text-center">LecCom's Member QR Detected!</h4>
            ...
            <div class="attendance-list">
                <h4 align="center">List of Present in LecCom</h4>
    ...
    <script>
        ...
        function deleteAttendance(id) {
            if (confirm("Do you want to remove this attendance?")) {
                window.location = "../endpoint_qr_leccom/delete-attendance.php?attendance=" + id;
            }
        }
    </script>
        </main>
